...
export default function ExitInterviewModal({ isOpen, onClose, employee, onSubmit }) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-auto bg-[#24243e]/95 backdrop-blur-xl border border-gray-700/50 text-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 py-4">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label className="text-gray-300">Exit Date</Label>
                <Popover>
                  <PopoverTrigger asChild>
                    <Button variant="outline" className="w-full justify-start text-left bg-gray-800/50 border-gray-600 text-white">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label className="text-gray-300">Overall Satisfaction Rating</Label>
            ...
            <div className="space-y-2">
              <Label className="text-gray-300">What did you enjoy most about working here?</Label>
              <Textarea
            ...
            <div className="space-y-2">
              <Label className="text-gray-300">What could we improve?</Label>
              <Textarea
            ...
            <div className="space-y-2">
              <Label className="text-gray-300">Cultural Considerations (Marshall Islands specific)</Label>
              <Textarea
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <Label className="text-gray-300">Exit checklist completed</Label>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <Label className="text-gray-300">Final pay processed</Label>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <Label className="text-gray-300">Equipment returned</Label>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <Label className="text-gray-300">System access revoked</Label>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <Label className="text-gray-300">Eligible for rehire</Label>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <Label className="text-gray-300">Would recommend company to others</Label>
                <Switch
